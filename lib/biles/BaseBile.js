...
var basebile=function(container,path,importInfo){
	this._path = path;
    ...
    this._warnmessage=[];
    this._errormessage=[];
    this._isimport=importInfo?true:false;
    this._importPath = importInfo?(importInfo.path[importInfo.path.length-1]==="/"?importInfo.path:importInfo.path+"/"):"";
...
basebile.prototype.getImportPath=function () {
    return this._importPath;
};
basebile.prototype.getImportInfo=function () {
