...
bilecontainer.create=function (path) {
    var bile=null;
    ...
    if(!isbinaryfile.sync(_path)){
        ...
        if(ispacket){
            bile=new packetbile(this,_path,content);
        }else{
            bile=new textbile(this,_path,content);
        }
    }else{
        bile=new binarybile(this,_path);
    }
    return bile;
};
bilecontainer.add=function (path) {
